...
def calculate_buildup_and_direct_attacks_under_10_passes(df):
    ...
    - Buildup Attacks: Possessions with 5-9 passes ending in a shot or penalty box entry.
    - Direct Attacks (<10 passes): Possessions starting in the team's half and reaching the final third in 3-9 passes.
